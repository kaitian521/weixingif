...
LOCAL_C_INCLUDES  :=  \
	...
	${JPEG_SRC_PATH} \
	${FREETYPE_SRC_PATH}include/freetype \
	${FREETYPE_SRC_PATH}include/freetype/config
...
LOCAL_MODULE    := magick
LOCAL_CFLAGS += -DHAVE_CONFIG_H -DXLOCALE_NOT_USED -DMAGICKCORE_FREETYPE_DELEGATE -DMAGICKCORE_HAVE_FT2BUILD_H -DMAGICKCORE_PNG_DELEGATE \
				-DMAGICKCORE_JPEG_DELEGATE -DMAGICKCORE_JP2_DELEGATE
LOCAL_C_INCLUDES  :=  \
	$(IMAGE_MAGICK) \
	$(IMAGE_MAGICK)magick \
	${PNG_SRC_PATH} \
...
LOCAL_SRC_FILES += \
	${IMAGE_MAGICK}utilities/convert.c \
...
LOCAL_SRC_FILES += \
	xyz_doutu_doutu_imagemagick_ImageMagickUtil.cpp
